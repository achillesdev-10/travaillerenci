  ...
  return (
    <aside className="flex h-full w-full flex-col border-r border-white/[0.06] bg-slate-950 text-white">
      ...
      <div className="border-b border-white/[0.06] px-6 py-6">
        <Link href="/cz7tk" onClick={handleNavigate} className="flex items-center gap-3">
      ...
      <nav className="mt-5 flex-1 space-y-1 overflow-y-auto px-3">
        {NAV_ITEMS.map((item) => {
          const active =
            item.href === '/cz7tk' ? pathname === item.href : pathname.startsWith(item.href);
